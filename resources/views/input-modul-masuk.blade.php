...
@section('content')
    ...
    <div class="row h-100">
        <div class="col-lg-6 m-auto">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Input Modul Masuk</h5>
                    <form action="modul" method="post" class="row g-3 main_form">
                        @csrf
                        <div class="mt-3">
                        ...
                        <div class="mt-3">
                            ...
                            <input type="text" class="form-control" id="tipe-board" name="tipe_board" value="{{ old('tipe_board') }}">
