...
@section('title', 'List Deleted Sfp Keluar')

@section('content')
<h1>List Deleted Sfp Keluar</h1>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Pulihkan Sfp</h1>
...
<script>
    $(function (){
        $('#datatables').DataTable({
            ...
            serverSide: true,
            scrollX: true,
            ajax: '/logan/list-data/sfp-keluar/jsonSfpKeluarDeleted',
            columns: [
